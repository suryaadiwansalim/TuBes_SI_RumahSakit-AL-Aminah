...
<div class="card shadow mb-4">
  ...
  <div class="form-group">
    ...
    <input type="number" name="id_obat" class="form-control" id="exampleInputPassword1" placeholder="">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Nama obat</label>
    <input type="text" name="nama_obat" class="form-control" id="exampleInputPassword1" placeholder="nama obat">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Jenis Obat</label>
    <input type="text" name="jenis_obat" class="form-control" id="exampleInputPassword1" placeholder="jenis obat">
  </div>
  <div class="form-group">

...
<div class="card shadow mb-4">
  ...
  <div class="form-group">
    ...
    <input type="text" name="id_pembayaran" class="form-control" id="exampleInputPassword1" placeholder="ID Pembayaran" value="">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Total Pembayaran</label>
    <input type="text" name="total_pembayaran" class="form-control" id="exampleInputPassword1" placeholder="total pembayaran" value="">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Tanggal Pembayaran</label>
    <input type="date" name="tanggal_pembayaran" class="form-control" id="exampleInputPassword1" placeholder="tanggal pembayaran" value="">
  </div>
